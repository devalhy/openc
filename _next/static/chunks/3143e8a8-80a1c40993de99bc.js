        ...
        43869: function(t, e, i) {
            ...
            s = "undefined" !== typeof window ? window : this, r = function(t) {
                ...
                return e(i, "Core/Globals.js", [], (function() {
                    var e, i;
                    return (i = e || (e = {})).SVG_NS = "http://www.w3.org/2000/svg", i.product = "Highcharts", i.version = "10.2.0", i.win = "undefined" !== typeof t ? t : {}, i.doc = i.win.document, i.svg = i.doc && i.doc.createElementNS && !!i.doc.createElementNS(i.SVG_NS, "svg").createSVGRect, i.userAgent = i.win.navigator && i.win.navigator.userAgent || "", i.isChrome = -1 !== i.userAgent.indexOf("Chrome"), i.isFirefox = -1 !== i.userAgent.indexOf("Firefox"), i.isMS = /(edge|msie|trident)/i.test(i.userAgent) && !i.win.opera, i.isSafari = !i.isChrome && -1 !== i.userAgent.indexOf("Safari"), i.isTouchDevice = /(Mobile|Android|Windows Phone)/.test(i.userAgent), i.isWebKit = -1 !== i.userAgent.indexOf("AppleWebKit"), i.deg2rad = 2 * Math.PI / 360, i.hasBidiBug = i.isFirefox && 4 > parseInt(i.userAgent.split("Firefox/")[1], 10), i.hasTouch = !!i.win.TouchEvent, i.marginNames = ["plotTop", "marginRight", "marginBottom", "plotLeft"], i.noop = function() {}, i.supportsPassiveEvents = function() {
                        var t = !1;
                        if (!i.isMS) {
                    ...
                    return a = function() {
                        ...
                        return e.filterUserAttributes = function(t) {
                            ...
                            var i = [];
                            if (t = t.trim().replace(/ style="/g, ' data-style="'), u) t = (new DOMParser).parseFromString(d ? d.createHTML(t) : t, "text/html");
                            else {
                                var o = s("div");
                                o.innerHTML = t, t = {
                                    body: o
                    ...
                    return t = function() {
                        ...
                        return t.prototype._defaultGetter = function(t) {
                            ...
                            return e = s.defer, P(l.hidden, l.msHidden, l.webkitHidden, !1) && (s.duration = 0), 0 !== s.duration ? (i && (s.complete = i), O((function() {
                                o.element && r(o, t, s)
                            }), e)) : (this.attr(t, void 0, i || s.complete), A(t, (function(t, e) {
                            ...
                            var e = this.styles,
                                ...
                                o = this.element,
                                s = !e;
                            if (t.color && (t.fill = t.color), e && A(t, (function(t, o) {
                                    e && e[o] !== t && (i[o] = t, s = !0)
                                })), s) {
                                if (e && (t = b(e, i)), null === t.width || "auto" === t.width) delete this.textWidth;
                                else if ("text" === o.nodeName.toLowerCase() && t.width) var r = this.textWidth = L(t.width);
                                this.styles = t, r && !d && this.renderer.forExport && delete t.width;
                                var n = T(t);
                                o.namespaceURI === this.SVG_NS && ["textOutline", "textOverflow", "width"].forEach((function(t) {
                                    return n && delete n[t]
                                })), y(o, n), this.added && ("text" === this.element.nodeName && this.renderer.buildText(this), t.textOutline && this.applyTextOutline(t.textOutline))
                            }
                            return this
                            ...
                            if (v(a)) {
                                var f = a.toString(); - 1 === f.indexOf("<") && (f = f.replace(/[0-9]/g, "0")), f += ["", i, u, this.textWidth, o, n && n.textOverflow, n && n.fontWeight].join()
                            }
                            if (f && !e && (p = l[f]), !p) {
                                if (d || r.forExport) {
                                    try {
                                        ...
                                        C(g) && g("none"), p = s.getBBox ? b({}, s.getBBox()) : {
                                            width: s.offsetWidth,
                                            height: s.offsetHeight
                                        }, C(g) && g("")
                                    } catch (x) {}(!p || 0 > p.width) && (p = {
                                        x: 0,
                                        y: 0,
                                        width: 0,
                                        height: 0
                                ...
                                if (r.isSVG && (r = p.width, e = p.height, d && (p.height = e = {
                                    ...
                                    d = Number(s.getAttribute("y") || 0) - p.y, o = {
                                        right: 1,
                                        center: .5
                                    }[o || 0] || 0, n = i * h, u = (i - 90) * h;
                                    var m = r * Math.cos(n);
                                    i = r * Math.sin(n), g = Math.cos(u), n = Math.sin(u), m = (g = (u = (r = p.x + o * (r - m) + d * g) + m) - e * g) - m, i = (e = (o = (d = p.y + d - o * i + d * n) + i) - e * n) - i, p.x = Math.min(r, u, g, m), p.y = Math.min(d, o, e, i), p.width = Math.max(r, u, g, m) - p.x, p.height = Math.max(d, o, e, i) - p.y
                                }
                                if (f && ("" === a || 0 < p.height)) {
                            ...
                            return this.attr("class", ("" + this.attr("class")).replace(M(t) ? new RegExp("(^| )".concat(t, "( |$)")) : t, " ").replace(/ +/g, " ").trim())
                    ...
                    return function() {
                        ...
                        return e.prototype.buildSVG = function() {
                            ...
                            var l = [r, this.ellipsis, this.noWrap, this.textLineHeight, this.textOutline, this.fontSize, this.width].join();
                            if (l !== e.textCache) {
                                for (e.textCache = l, delete e.actualWidth, l = a.length; l--;) i.removeChild(a[l]);
                            ...
                            return l(this.renderer.escapes, (function(i, o) {
                    ...
                    return t = function() {
                        ...
                        return t.chart = function(e, i, o) {
                            ...
                            var t, e = this,
                                ...
                                r = e.container,
                                n = r && r.parentNode;
                            for (W(e, "destroy"), e.renderer.forExport ? R(b, e) : b[e.index] = void 0, s.chartCount--, e.renderTo.removeAttribute("data-highcharts-chart"), q(e), t = i.length; t--;) i[t] = i[t].destroy();
                            ...
                            if (c) {
                                ...
                                t.chart && t.update({}, !1)
                            }), this), d = c && c.width, c = c && (Y(c.height) ? Z(c.height, d || n.chartWidth) : c.height), r || X(d) && d !== n.chartWidth || X(c) && c !== n.chartHeight ? n.setSize(d, c, o) : V(e, !0) && n.redraw(o), W(n, "afterUpdate", {
                                options: t,
                                redraw: e,
                                animation: o
                            })
                    ...
                    return t = function() {
                        ...
                        return t.prototype.init = function(t, e) {
                            ...
                            if (b = (t = b || t || []).length, e = B(e, !0), l && l.enabled && (t = this.sortData(t)), h.options.chart.allowMutatingData && !1 !== o && b && n && !s.cropped && !s.hasGroupedData && s.visible && !s.isSeriesBoosting && (g = this.updateData(t, i)), !g) {
                    ...
                    var a = i.format,
                        ...
                        g = function() {
                            ...
                            return t.prototype.destroy = function() {
                                ...
                                e && n && (r = e.getBBox(), o = e.padding, h = "left" === h ? a.inverted ? -o : o : "right" === h ? r.width : a.inverted && "center" === h ? r.width / 2 : a.inverted ? i ? r.width + o : -o : r.width / 2, i = a.inverted ? r.height / 2 : i ? -o : r.height, this.alignOptions.x = f(this.options.x, 0), this.alignOptions.y = f(this.options.y, 0), n.x -= h, n.y -= i, e.align(this.alignOptions, null, n), a.isInsidePlot(e.alignAttr.x + h - this.alignOptions.x, e.alignAttr.y + i - this.alignOptions.y) ? e.show() : (e.hide(), t = !1), t && s.prototype.justifyDataLabel.call(this.axis, e, this.alignOptions, e.alignAttr, r, n), e.attr({
                                    x: e.alignAttr.x,
                                    y: e.alignAttr.y
                    ...
                    return e.prototype.getStacks = function() {
                        ...
                        if (e && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                            ...
                            n = n.stack;
                            var p, u, m = "-" + (t = t ? "" + this.type + ",".concat(e) : this.stackKey),
                                y = this.negStacks,
                                v = this.yAxis,
                                x = v.stacking.stacks,
                        ...
                        return !l(t) || t.x !== e || o && t.stackKey !== o ? t = {
                            x: e,
                            index: 0,
                            key: o,
                            stackKey: o
                    ...
                    return function(t) {
                        function e(t, e, i, o, s) {
                            var r = this,
                                ...
                                d = p(t.dlBox && t.dlBox.centerX, t.plotX),
                                u = t.plotY,
                                f = i.rotation,
                                g = i.align,
                                m = n(d) && n(u) && h.isInsidePlot(d, Math.round(u), {
                                    inverted: l,
                                    paneCoordinates: !0,
                                    series: r
                                }),
                                ...
                                v = "justify" === p(i.overflow, c ? "none" : "justify"),
                                x = this.visible && !1 !== t.visible && (t.series.forceDL || c && !v || m || p(i.inside, !!this.options.stacking) && o && h.isInsidePlot(d, l ? o.x + 1 : o.y + o.height - 1, {
                                    inverted: l,
                                    paneCoordinates: !0,
                                    series: r
                                }));
                            if (x && n(d) && n(u)) {
                                ...
                                o = a({
                                    x: l ? this.yAxis.len - u : d,
                                    y: Math.round(l ? this.xAxis.len - d : u),
                                    width: 0,
                                    height: 0
                                }, o), a(i, {
                                    width: g.width,
                                ...
                                }, b = [g.x - Number(e.attr("x")), g.y - Number(e.attr("y"))], y(d), e[s ? "attr" : "animate"](d)) : (y(o), e.align(i, void 0, o), d = e.alignAttr), v && 0 <= o.height ? this.justifyDataLabel(e, i, d, g, o, s) : p(i.crop, !0) && (o = d.x, y = d.y, o += b[0], y += b[1], x = h.isInsidePlot(o, y, {
                                    paneCoordinates: !0,
                                    series: r
                        ...
                        function i() {
                            ...
                            if (m = g.defer ? s(e, m, t) : {
                                ...
                                y.attr({
                                    opacity: +a
                                }), !a && (a = t.dataLabelsGroup) && (t.visible && y.show(), a[i.animation ? "animate" : "attr"]({
                                    opacity: 1
                                    ...
                                    u(f(g, o.dlOptions || o.options && o.options.dataLabels)).forEach((function(s, a) {
                                        var h = s.enabled && (!o.isNull || o.dataLabelOnNull) && function(t, e) {
                                            ...
                                            f = !u,
                                            g = p(s.distance, o.labelDistance);
                                        if (h) {
                                            ...
                                            var x = s.rotation;
                                            e.styledMode || (v.color = p(s.color, v.color, t.color, "#000000"), "contrast" === v.color ? (o.contrastColor = c.getContrast(o.color || t.color), v.color = !n(g) && s.inside || 0 > g || i.stacking ? o.contrastColor : "#000000") : delete o.contrastColor, i.cursor && (v.cursor = i.cursor));
                                            var b = {
                                                r: s.borderRadius || 0,
                                                rotation: x,
                                                padding: s.padding,
...
//# sourceMappingURL=3143e8a8-80a1c40993de99bc.js.map